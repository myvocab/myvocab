...
//   bookWord=document.getElementById('numberInTable').value ;
 bookWord=bw;
  wLearn = document.getElementById("WordEdit").value;
     ...
     var url = "lib/setLearn.php?wLearn="+wLearn+"&chval="+document.getElementById("chLearn").value;
 
 if (request1.readyState==0 || request1.readyState==4 )
 { request1.open("GET", url, true);request1.onreadystatechange = memWordResponse1;request1.send(null);moveUp(bookWord); exit();}
 if (request2.readyState==0 || request2.readyState==4 )
 { request2.open("GET", url, true);request2.onreadystatechange = memWordResponse2;request2.send(null);moveUp(bookWord); exit();}
 if (request3.readyState==0 || request3.readyState==4 )
 { request3.open("GET", url, true);request3.onreadystatechange = memWordResponse3;request3.send(null);moveUp(bookWord); exit();}
 if (request4.readyState==0 || request4.readyState==4 )
 { request4.open("GET", url, true);request4.onreadystatechange = memWordResponse4;request4.send(null);moveUp(bookWord); exit();}
 if (request5.readyState==0 || request5.readyState==4 )
 { request5.open("GET", url, true);request5.onreadystatechange = memWordResponse5;request5.send(null);moveUp(bookWord); exit();}
 if (request6.readyState==0 || request6.readyState==4 )
 { request6.open("GET", url, true);request6.onreadystatechange = memWordResponse6;request6.send(null);moveUp(bookWord); exit();}
 if (request7.readyState==0 || request7.readyState==4 )
 { request7.open("GET", url, true);request7.onreadystatechange = memWordResponse7;request7.send(null);moveUp(bookWord); exit();}
 if (request8.readyState==0 || request8.readyState==4 )
 { request8.open("GET", url, true);request8.onreadystatechange = memWordResponse8;request8.send(null);moveUp(bookWord); exit();}
 if (request9.readyState==0 || request9.readyState==4 )
 { request9.open("GET", url, true);request9.onreadystatechange = memWordResponse9;request9.send(null);moveUp(bookWord); exit();}
 if (request10.readyState==0 || request10.readyState==4 )
 { request10.open("GET", url, true);request10.onreadystatechange = memWordResponse10;request10.send(null);moveUp(bookWord); exit();}
 if (request11.readyState==0 || request11.readyState==4 )
 { request11.open("GET", url, true);request11.onreadystatechange = memWordResponse11;request11.send(null);moveUp(bookWord); exit();}
 if (request12.readyState==0 || request12.readyState==4 )
 { request12.open("GET", url, true);request12.onreadystatechange = memWordResponse12;request12.send(null);moveUp(bookWord); exit();}
 if (request13.readyState==0 || request13.readyState==4 )
 { request13.open("GET", url, true);request13.onreadystatechange = memWordResponse13;request13.send(null);moveUp(bookWord); exit();}
 if (request14.readyState==0 || request14.readyState==4 )
 { request14.open("GET", url, true);request14.onreadystatechange = memWordResponse14;request14.send(null);moveUp(bookWord); exit();}
 if (request15.readyState==0 || request15.readyState==4 )
 { request15.open("GET", url, true);request15.onreadystatechange = memWordResponse15;request15.send(null);moveUp(bookWord); exit();}
//document.getElementById("tmp2").value="a15a";
//memWord();
...
showWord(bookWord);
 ...
 function memWordResponse1() {
    if (request1.readyState == 4){
        var tagList = request1.responseText.split("@(@");
        fillTmp2();
document.getElementById('tmp3').value = document.getElementById('tmp3').value + "1" + tagList[1];   
    }
 } 

 function memWordResponse2() {
    if (request2.readyState == 4){
        var tagList = request2.responseText.split("@(@");
document.getElementById('tmp3').value = document.getElementById('tmp3').value +  "2" +tagList[1];      
    }
 } 
 function memWordResponse3() {
    if (request3.readyState == 4){
        var tagList = request3.responseText.split("@(@");
document.getElementById('tmp3').value = document.getElementById('tmp3').value +  "3" +tagList[1];      
    }
 } 
 function memWordResponse4() {
    if (request4.readyState == 4){
        var tagList = request4.responseText.split("@(@");
document.getElementById('tmp3').value = document.getElementById('tmp3').value +  "4" +tagList[1];     
    
    }
 } 
 function memWordResponse5() {
    if (request5.readyState == 4){
        var tagList = request5.responseText.split("@(@");
document.getElementById('tmp3').value = document.getElementById('tmp3').value +  "5" +tagList[1];     
    }
 } 
 function memWordResponse6() {
    if (request6.readyState == 4){
        var tagList = request6.responseText.split("@(@");
document.getElementById('tmp3').value = document.getElementById('tmp3').value +  "6" +tagList[1];     

    }
 } 
 function memWordResponse7() {
    if (request7.readyState == 4){
        var tagList = request7.responseText.split("@(@");
document.getElementById('tmp3').value = document.getElementById('tmp3').value +  "7" +tagList[1];     
    }
 } 
 function memWordResponse8() {
    if (request8.readyState == 4){
        var tagList = request8.responseText.split("@(@");
document.getElementById('tmp3').value = document.getElementById('tmp3').value +  "8" +tagList[1];     
    }
 } 
 function memWordResponse9() {
    if (request9.readyState == 4){
        var tagList = request9.responseText.split("@(@");
document.getElementById('tmp3').value = document.getElementById('tmp3').value +  "9" +tagList[1];     
    }
 } 
 function memWordResponse10() {
    if (request10.readyState == 4){
        var tagList = request10.responseText.split("@(@");
document.getElementById('tmp3').value = document.getElementById('tmp3').value +  "10" +tagList[1];     
    }
 } 
 function memWordResponse11() {
    if (request11.readyState == 4){
        var tagList = request11.responseText.split("@(@");
document.getElementById('tmp3').value = document.getElementById('tmp3').value +  "11" +tagList[1];     
    }
 } 
 function memWordResponse12() {
    if (request12.readyState == 4){
        var tagList = request12.responseText.split("@(@");
document.getElementById('tmp3').value = document.getElementById('tmp3').value +  "12" +tagList[1];     
    }
 } 
 function memWordResponse13() {
    if (request13.readyState == 4){
        var tagList = request13.responseText.split("@(@");
document.getElementById('tmp3').value = document.getElementById('tmp3').value +  "13" +tagList[1];     
    }
 } 
 function memWordResponse14() {
    if (request14.readyState == 4){
        var tagList = request14.responseText.split("@(@");
document.getElementById('tmp3').value = document.getElementById('tmp3').value +  "14" +tagList[1];     
    }
 } 
 function memWordResponse15() {
    if (request15.readyState == 4){
        var tagList = request15.responseText.split("@(@");
document.getElementById('tmp3').value = document.getElementById('tmp3').value +  "15" +tagList[1];     
    }
 } 
