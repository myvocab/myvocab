...
<input type="text" id="WordTrs"  style="position:absolute;text-align:left;left:575px;top:64px;width:300px;height:20px;border:1px #C0C0C0 solid;font-family:Courier New;font-size:13px;font-weight:bold;z-index:2" name="WEdit" value="">
